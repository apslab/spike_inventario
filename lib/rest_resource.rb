class RestResource
  ...
  # This method set the resource url if you need to change the url provided by provider (@see #provider).
  ...
  #
  # @param [String] provider name (same load in config/services.yml file)
